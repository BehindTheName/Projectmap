...
function MaakZaal(){
	...
	for(var RijNummer = 0; RijNummer < zaal2.length; RijNummer++){
		for (var StoelNummer = 0; StoelNummer < zaal2[RijNummer].length; StoelNummer++ )
		{
			switch (zaal2[RijNummer][StoelNummer])
			{
